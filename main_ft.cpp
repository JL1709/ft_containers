...
/*   Updated: 2022/02/03 19:17:46 by julian           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* ------------------------------------------------------------------------------------------------------------------ */
	...
	// ft::vector<int> smyvector (2,200);        // vector with 2 elements
	// ft::stack<int> sfirst;                    // empty stack
	// ft::stack<int> ssecond (smyvector);         // stack initialized to copy of deque
	// ft::stack<int,ft::vector<int> > sthird;  // empty stack using vector
	// ft::stack<int,ft::vector<int> > sfourth (smyvector);
